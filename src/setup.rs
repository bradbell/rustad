...
//
// Define the SimpleFloat trait for the AzFloat<f32> and Az<f64>
crate::simple_float::impl_simple_float_for_az_float!(f32);
crate::simple_float::impl_simple_float_for_az_float!(f64);
