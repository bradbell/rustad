...
///
/// * sub_pattern :
///   This is a sparsity pattern where we are c mputing the
///   Jacobian. All of the column (row) indices must be less than
///   the variable domain dimension (range dimension) for this ADfn object.
///
/// * color_vec :
///   This is a colorring for the Jacobian matrix for f.
///
///
/// * trace :
...
///
/// * jacobian :
///   The return value the Jacobian on the subset of the sparsity pattern.
