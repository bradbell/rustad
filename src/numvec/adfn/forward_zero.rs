...
///
/// * range_zero :
/// The first return has elements of type *E* and
...
///
/// * var_zero :
/// The second return has elements of type *E* and
...
/// let x        : Vec<f32> = vec![ 1.0, 1.0, 1.0 ];
/// let ax                  = start_recording(x);
/// let mut asum            = AD::from(0.0f32);
/// for j in 0 .. ax.len() {
///     asum += &ax[j];
/// }
/// let ay = vec![ asum ];
    ...
    ( $suffix:ident, $V:ident, $E:ty ) => { paste::paste! {
        ...
        ) -> ( Vec<$E> , Vec<$E> )
        {
            ...
            if trace {
                ...
                println!( "var_index, var_value, op_name, arg" );
            }
