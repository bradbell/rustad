...
macro_rules! eval_compare_forward_fun { ($name:ident) => { paste::paste! {
        ...
        E : CompareAsNumber,
    {
        ...
        dyp_both[ res ] = lhs_ref. [< num_ $name >] ( rhs_ref );
    }
    #[doc = concat!(
...
//
// rust_src_none
no_rust_src!(CompareAsNumber);
//
/// Set the operator information for the CompareAsNumber operators
///
/// * op_info_vec :
